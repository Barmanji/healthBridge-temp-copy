...
function Footer() {
  ...
  const socialLinks = [
    ...
    {
      icon: Github,
      href: "https://github.com/barmanji/healthbridge-app/",
      label: "GitHub",
    },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              Discover our HealthBridge platform, a modern and practical
          ...
          <div className="space-y-4">
            ...
            <p className="text-white/80 text-sm">
              ...
              innovations in HealthBridge, health tips, and much more.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-white/80 space-y-2">
              <p>ABESIT</p>
              <p>Info Tech Hub</p>
              <p>Saarthak building, 1st floor</p>
              <p className="pt-2">
                <a
                  href="tel:+91 99234242424"
        ...
        <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white/60">
            Copyright 2025 © HealthBridge.inc. All rights reserved.
          </p>
